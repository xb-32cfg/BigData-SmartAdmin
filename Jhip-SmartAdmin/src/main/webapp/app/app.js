...
angular.module('SmartAdminWebapp', [
    ...
    'infinite-scroll',
    'angular-loading-bar',
    'datatables', 'datatables.colreorder', 'datatables.fixedcolumns',
    'datatables.buttons',
    ...
    .config(function ($provide, $stateProvider, $urlRouterProvider, $httpProvider, $locationProvider, $translateProvider, tmhDynamicLocaleProvider, httpRequestInterceptorCacheBusterProvider, AlertServiceProvider, RestangularProvider) {
...
.config(function ($stateProvider) {
    ...
    "use strict";
    angular.module('app.maps', ['ui.router', 'uiGmapgoogle-maps'])
...
angular.module('app.tables').controller('DatatablesCtrl', function(DTOptionsBuilder, DTColumnBuilder){
    ...
    this.standardOptions = DTOptionsBuilder
        .fromSource('json/tables/datatables.standard.json')
