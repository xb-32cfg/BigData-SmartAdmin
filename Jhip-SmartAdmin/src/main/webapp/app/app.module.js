 ...
 * DEBUGGING MODE
 * debugState = true;
 * It will spit all debuging message inside browser console.
...
'use strict';
angular.module('app.dashboard', ['ui.router', 'ngResource'])
    .config(function ($stateProvider) {
        $stateProvider
            .state('app.dashboard', {
                url: '/dashboard',
        ...
        .state('app.maps', {
            ...
            views: {
                "content@app": {
                    ...
                    templateUrl: 'app/maps/views/school-google-map.html'
                }
            }
        })
});
...
'use strict';
angular.module('jhipsterbankApp').factory('User', function ($http, $q, APP_CONFIG, $cookies) {
    var dfd = $q.defer();
    var UserModel = {
...
angular.module("jhipsterbankApp").run(["$templateCache", function ($templateCache) {
...
angular.module('jhipsterbankApp').controller("ActivitiesCtrl", function ActivitiesCtrl($scope, $log, activityService) {
...
angular.module('jhipsterbankApp').directive('activitiesDropdownToggle', function ($log) {
...
angular.module('jhipsterbankApp').factory('Project', function ($http, APP_CONFIG) {
    return {
...
angular.module('jhipsterbankApp').directive('recentProjects', function (Project) {
    return {
        restrict: "EA",
        replace: true,
...
angular.module('jhipsterbankApp').controller('TodoCtrl', function ($scope, $timeout, Todo) {
...
angular.module('jhipsterbankApp').directive('toggleShortcut', function ($log, $timeout) {
...
angular.module('app.chat').factory('ChatApi', function ($q, $rootScope, AuthLoginUser, $http, APP_CONFIG) {
    var dfd = $q.defer();
    var _user;
    var ChatSrv = {
        initialized: dfd.promise,
    ...
    ChatSrv.initialized.then(function () {
        ...
        AuthLoginUser.initialized.then(function () {
            ChatSrv.setUser({
                ...
                picture: AuthLoginUser.picture,
                status: ChatSrv.status
            });
        });

        $rootScope.$watch(function () {
            return AuthLoginUser.username
...
angular.module('jhipsterbankApp').factory('Todo', function (Restangular, APP_CONFIG) {
...
angular.module('jhipsterbankApp').directive('todoList', function ($timeout, Todo) {
                ...
                "oTableTools": {
                    "aButtons": [
                        ...
                        "xls",
                        {
                            "sExtends": "pdf",
                            "sTitle": "BigData_PDF",
                            "sPdfMessage": "BigData PDF Export",
                            "sPdfSize": "letter"
                        },
                        {
                            "sExtends": "print",
                            "sMessage": "Generated by BigData Enterprise <i>(press Esc to close)</i>"
                        }
                    ],
